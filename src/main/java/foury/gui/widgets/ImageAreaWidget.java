...
public class ImageAreaWidget extends Widget {
	...
	public ImageAreaWidget(ImageData imageData, AppState appState) {
	...
	private void initialize(){
		...
		Mat newMat = new Mat(10, 10, CvType.CV_8UC4);
		displayedImage = ImageUtils.mat2Image(newMat, "." + appState.getFileExtension());
		imageView = new ImageView();
		setupScrollAndZoom();
	}

	public void displayImage(Image incomingImage) {
		this.displayedImage = incomingImage;
	...
	private void setupScrollAndZoom() {
